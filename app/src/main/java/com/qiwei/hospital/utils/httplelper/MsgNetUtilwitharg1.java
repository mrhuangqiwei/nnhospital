 ...
 */
public class MsgNetUtilwitharg1 {
  ...
  public MsgNetUtilwitharg1(String funname1, Handler handler1, ArrayList<String> arrayList1, ArrayList<String> brrayList1, int msg, final int arg1){
      arrayList.clear();
      brrayList.clear();
      crrayList.clear();
